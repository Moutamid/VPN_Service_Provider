package com.moutamid.vpn_service.view;
...
import com.moutamid.vpn_service.CheckInternetConnection;
import com.moutamid.vpn_service.DonateActivity;
import com.moutamid.vpn_service.R;
import com.moutamid.vpn_service.SharedPreference;
import com.moutamid.vpn_service.databinding.FragmentMainBinding;
import com.moutamid.vpn_service.interfaces.ChangeServer;
import com.moutamid.vpn_service.model.Server;
...
public class MainFragment extends Fragment implements View.OnClickListener, ChangeServer {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.btnThumbs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public void setStatus(String connectionState) {
        ...
        switch (connectionState) {
            case "DISCONNECTED":
                ...
                binding.logTv.setText("Connect Now !!!");
                break;
            case "CONNECTED":
