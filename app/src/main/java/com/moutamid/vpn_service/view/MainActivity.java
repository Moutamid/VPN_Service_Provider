...
import com.moutamid.vpn_service.adapter.ServerListRVAdapter;
import com.moutamid.vpn_service.interfaces.ChangeServer;
import com.moutamid.vpn_service.interfaces.NavItemClickListener;
import com.moutamid.vpn_service.model.Server;

import java.util.ArrayList;

import com.moutamid.vpn_service.Utils;
...
public class MainActivity extends AppCompatActivity implements NavItemClickListener {
    ...
    private ArrayList getServerList() {
        ...
        servers.add(new Server("United States",
                Utils.getImgURL(R.drawable.usa_img),
                "us.ovpn",
                "freeopenvpn",
                "416248023"
        ));
        servers.add(new Server("Japan",
                Utils.getImgURL(R.drawable.japan_img),
                "japan.ovpn",
                "vpn",
                "vpn"
        ));
        servers.add(new Server("Sweden",
                Utils.getImgURL(R.drawable.sweden_img),
                "sweden.ovpn",
                "vpn",
                "vpn"
        ));
        servers.add(new Server("Korea",
                Utils.getImgURL(R.drawable.korea_img),
                "korea.ovpn",
                "vpn",
                "vpn"
        ));
